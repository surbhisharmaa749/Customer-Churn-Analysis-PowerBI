...
## 📌 Project Overview
This project focuses on analyzing **customer churn patterns** using bank customer data.  
The goal is to identify key factors influencing customer churn and provide actionable insights for improving customer retention.
...
- Customers with **low credit scores** show a higher churn tendency  
